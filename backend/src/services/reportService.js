...
exports.getDailyEarnings = async (date) => {
...
exports.getMonthlyEarnings = async (month, year) => {
...
exports.getEarningsByDateRange = async (start_date, end_date) => {
